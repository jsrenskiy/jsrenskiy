### Renat Khusainov — Senior Fullstack Developer

Vue 3 · React · TypeScript · Node.js (Koa/Express) · PostgreSQL · AI integrations

I take products from architecture and prototype through to production and monetization. 6 years of commercial experience, including shipping my own SaaS products with paying users.

---

**Stack**

`Vue 3` `React` `TypeScript` `Pinia` `Redux Toolkit` `Vite` `Tailwind CSS` `Node.js` `Koa` `Express` `PostgreSQL` `MongoDB` `REST API` `Electron` `Chrome Extensions` `Docker` `GitHub Actions` `Vitest` `Playwright`

---

**Featured projects**

**[TaskFlow](https://github.com/jsrenskiy/taskflow)** — full-stack task board (open source)
...
📩 parabell241@gmail.com · ✈️ [@jsrenskiy](https://t.me/jsrenskiy)
